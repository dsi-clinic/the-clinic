...
The first draft videos should be graded according to the following point assignment (30 Points):
...
The second draft videos should be graded according to the following point assignment (30 Points):
* Slide quality (7 Points)
    * Do the slides use correct grammar, consistent formatting/style, and are they easy to read?
    * Are the slides too busy?
    * Are plots/graphs labeled correctly and easy to read?
